    ...
    <div className="main">
      ...
      <form onSubmit={handleSubmit(submitData)}>
        <div style={{display:"flex"}}>
          ...
          <input type="number" name="rollnum" autoComplete="off"
            ref={register({ required: true })}
            placeholder="Enter Roll Number"></input><br></br>
          {errors.lname && <span>**Please Enter Roll Number</span>}<br></br>
            </div>
            <div>
          ...
          {errors.lname && <span>**Please Enter Address</span>}<br></br>
            </div>
        </div>
...
<div>
        ...
        {errors.phone && <span>**Please Enter 10 Digits</span>}<br></br>
          ...
          <input type="text" name="subject" autoComplete="off"
            ref={register({ required: true })}
            placeholder="Enter Subjects"></input><br></br>
          {errors.lname && <span>**Please Enter Subjects</span>}<br></br>
            </div>
          <div>
          ...
          <br></br>
          {errors.lname && <span>**Please select Your Gender</span>}<br></br>
            </div>
